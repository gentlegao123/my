...
refresh();
	function refresh(){ 
		console.log("刷新");
		  ajax('/mall/goodsSortController/refresh.do',{},'json',function (data){
			  var html="";
...
function up1(sortCode){
	openLayer('upSort.jsp?sortCode='+sortCode,refresh);	
}
	
//查询_分页
 function selpage(){
	ajax("/mall/goodsSortController/selpageS.do",$("#form").serialize(),"json",function(data){
