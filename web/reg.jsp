  ...
  <div class="content content-nav-base  login-content">
    ...
    <div class="login-bg">
      <div class="login-cont w1200">
        <div class="form-box">
          <form class="layui-form" onsubmit="return false" id="reg">
            <legend>新用户注册</legend>
            <div class="layui-form-item">
              ...
              <div class="layui-inline">
                <div class="layui-input-inline">   
                  ...
                  <div class="layui-inline">
                <div class="layui-input-inline">   
                  <input type="text" name="customerName" id="customerName" lay-verify="required|phone" placeholder="请输入姓名" autocomplete="off" class="layui-input">
                </div>
              </div>
...
<img src="/JAVAE/yzmServletA" onclick="this.src='/JAVAE/yzmServletA?'+Math.random();" /> </label>
<div class="layui-inline">
<input type="text" name="code" class="layui-input" />
      ...
      <!--         <div class="layui-inline veri-code">
            ...
            <div class="layui-form-item login-btn">
              <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="demo1" onclick="reg()" />注册</button> 
              </div>
            </div>
          </form>
        </div>
  ...
  function reg (){
  	console.log("reg");
  ajax('/mall/customerController/reg.do',$("#reg").serialize(),'json',function (data){
  	if(data==1){layer.msg("注册成功!")}
  	else if(data==3){layer.msg("验证码错误!")}
  	else{layer.msg("账号已存在!")}
  })
  }
